  ...
  var e = {
      34: function (e, n, t) {
        ...
        class s extends r.default {
          constructor() {
            const e = "API_URL=https://rss-news-api.onrender.com/",
              n = "97b7eb80fb53445ebb6d286783bbc252";
            e && n && super(e, { apiKey: n });
          }
        }
        n.default = s;
      },
      41: function (e, n, t) {
        ...
        class i {
          constructor() {
            (this.news = new r.default()), (this.sources = new s.default());
          }
          drawNews(e) {
        ...
        function o(e, o) {
          for (var s = {}, i = [], a = 0; a < e.length; a++) {
            ...
            if (-1 !== f) n[f].references++, n[f].updater(p);
              ...
              var m = r(p, o);
              (o.byIndex = a),
                n.splice(a, 0, { identifier: u, updater: m, references: 1 });
            }
            i.push(u);
          }
          return i;
      ...
      168: (e, n, t) => {
        ...
        (h.styleTagTransform = m()),
          ...
          r()(_.A, h);
        const w = _.A && _.A.locals ? _.A.locals : void 0;
      },
      180: (e, n, t) => {
        t.r(n), t.d(n, { default: () => w });
        var o = t(72),
      ...
      244: function (e, n, t) {
        ...
        class s extends r.default {
          ...
          getNews(e, n) {
            ...
            for (; t !== o; )
              if (t instanceof HTMLElement && o instanceof HTMLElement) {
                if (t.classList.contains("source__item")) {
                  const e = t.getAttribute("data-source-id");
                  return void (
                    e &&
                    o.getAttribute("data-source") !== e &&
                    (o.setAttribute("data-source", e),
                    super.getResp(
      ...
      359: (e, n, t) => {
        ...
        n.default = class {
          ...
          load(e, n, t, o = {}) {
            fetch(this.makeUrl(o, n), { method: e })
      ...
      738: function (e, n, t) {
        ...
        n.default = class {
          constructor() {
            (this.controller = new r.default()), (this.view = new s.AppView());
          }
          start() {
            document
            ...
            draw(e) {
              ...
              e.forEach((e) => {
                if (!(t instanceof HTMLTemplateElement))
                  return void console.log("No sources item!");
                ...
                o instanceof DocumentFragment &&
                  ...
                  o
                    ...
                    .setAttribute("data-source-id", e.id),
                  n.append(o));
              }),
          ...
          (n.default = class {
            draw(e) {
              const n = e.length >= 10 ? e.filter((e, n) => n < 10) : e,
                ...
                o = document.querySelector("#newsItemTemp"),
                r = document.querySelector(".news");
              n.forEach((e, n) => {
                if (!(o instanceof HTMLTemplateElement))
                  return void console.log("No news item!");
                const r = o.content.cloneNode(!0);
                r instanceof DocumentFragment &&
                  (n % 2 && r.querySelector(".news__item").classList.add("alt"),
                  (r.querySelector(".news__meta-photo").style.backgroundImage =
                    `url(${e.urlToImage || "img/news_placeholder.jpg"})`),
                  (r.querySelector(".news__meta-author").textContent =
                    e.author || e.source.name),
                  (r.querySelector(".news__meta-date").textContent =
                    e.publishedAt.slice(0, 10).split("-").reverse().join("-")),
                  (r.querySelector(".news__description-title").textContent =
                    e.title),
                  (r.querySelector(".news__description-source").textContent =
                    e.source.name),
                  (r.querySelector(".news__description-content").textContent =
                    e.description),
                  r
                    .querySelector(".news__read-more a")
                    .setAttribute("href", e.url),
                  t.append(r));
              }),
                r && ((r.innerHTML = ""), r.appendChild(t));
            }
          });
      },
    },
