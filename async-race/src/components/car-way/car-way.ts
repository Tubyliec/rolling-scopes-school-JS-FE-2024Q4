import { FlagImage } from '../../assets/images/flag';
...
export class CarWay extends ViewCreator {
  public controlContainer: IsHTMLElement;
  public selectButton: IsHTMLElement;
  public removeButton: IsHTMLElement;
  public carName: IsHTMLElement;
  public carContainer: IsHTMLElement;
  public tripContainer: IsHTMLElement;
  public flag: IsHTMLElement;
  public image: string;
  ...
  public init(color: string, carName: string): void {
    this.createControlContainer(carName);
    if (this.controlContainer) this.addInnerElement(this.controlContainer);
    this.createCarImage(color);
    this.createCarContainer();
    if (this.carContainer) this.addInnerElement(this.carContainer);
  ...
  public createControlContainer(carName: string): void {
    this.controlContainer = new ViewCreator({
      tag: 'div',
  ...
  public createCarContainer(): void {
    this.carContainer = new ViewCreator({
      tag: 'div',
      css: ['car-container'],
    }).getElement();
